...
export const ALL_HOLIDAYS = [
  ...
  { name: "Policy Anniversary", kind: "policy_anniversary", enabled: true, message: "Happy {years}-year policy anniversary, {first_name}! Thanks for trusting me with your coverage - let me know if anything's changed and we should take another look at it." },
...
// year. Birthday and policy anniversary return null since they're
// per-contact, not a shared date.
export function resolveHolidayDate(holiday, year) {
  ...
  return null; // birthday or policy_anniversary
}

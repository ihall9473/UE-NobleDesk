// Maps US area codes to state abbreviations, so a contact's state can be
// inferred automatically from their phone number when it hasn't been set
// explicitly. Source: NANPA public area code assignments.
export const AREA_CODE_TO_STATE = {
  ...
  831: "CA", 858: "CA", 909: "CA", 916: "CA", 925: "CA", 949: "CA", 951: "CA",
  303: "CO", 719: "CO", 720: "CO", 970: "CO",
  203: "CT", 475: "CT", 860: "CT", 959: "CT",
  302: "DE",
  239: "FL", 305: "FL", 321: "FL", 352: "FL", 386: "FL", 407: "FL", 561: "FL",
  689: "FL", 727: "FL", 754: "FL", 772: "FL", 786: "FL", 813: "FL", 850: "FL",
  ...
  419: "OH", 440: "OH", 513: "OH", 567: "OH", 614: "OH", 740: "OH", 937: "OH",
...
// Given a phone number in any common format, returns the 2-letter state
// abbreviation inferred from its area code, or null if unknown. Note: this
// is only a rough signal - cell numbers get ported when people move, so it
// won't always match where someone actually lives today.
export function inferStateFromPhone(phone) {
  if (!phone) return null;
  const digits = phone.replace(/\D/g, "");
  const areaCode = digits.length === 11 ? digits.slice(1, 4) : digits.slice(0, 3);
  return AREA_CODE_TO_STATE[Number(areaCode)] || null;
}
